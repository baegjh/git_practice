...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZOWpucxGdY1FSEbJHsjIWIr3pxVcJeCtVVrdn3DsyTjK" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="C1D67257" />
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    ...
                    <p class="content_div_title_desc">
                        이미지 도면을 인식하여 설계정보의 디지털화 및 Intelligent P&ID로 변환
                    </p>
                ...
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>AI 등의 4차산업 기술을 적용한 도면 정보 인식 및 추출</li>
                            <li>설계정보와의 연계를 통한 도면 디지탈화</li>
                            <li>다양한 인식결과 Validation 및 보정 Utility</li>
                            <li>
                                다양한 Reporting 기능
                                <p>Line list, Equipment list, Instrument list, Valve list, Note list, BOM등</p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/id2_img_1.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            
                            <li>Hexagon SP P&ID 및 AVEVA P&ID 등의  Intelligent P&ID 로의 자동 전환</li>
                        </ul>
                    </div>
                </div>
