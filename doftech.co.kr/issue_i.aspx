...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZKLpT40/3izlqrf6EjvlArwpqvuCaPxJv3Fh6SjC0ZZ6" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="99B1F827" />
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    ...
                    <p class="content_div_title_desc">
                        배관 ISO 도면을 이슈 하기 위한 관리 프로그램 (PDS , PDMS , SP3D)<br />
                        AutoCAD 2D, MicroStation 도면 자체로부터 BOM 산출 및 Graphic과 BOM Consistency check
                    </p>
                </div>
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>3D MODEL과 연계하여 데이터 관리</li>
                            <li>BOM 파일 생성 자동화</li>
                            <li>ISO DRAWING의 Q/C 자동화
                                <p>설계 M/H 단축 , 에러 방지</p>
                            </li>
                            <li>LINE DATA 변경 사항에 대한 신속한 반영</li>
                            <li>DRAWING INDEX 작성</li>
                            <li>BATCH PLOTTING 기능 제공</li>
                            <li>Utilities</li>
                        </ul>
                    </div>
                </div>
