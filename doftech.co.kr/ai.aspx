...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZAumxB9bP7a3jnyIPiiBci0nU7oDmUHg8HgiIrGo9m9O" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B79885D6" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="ai.aspx">AI 기반 도면 인식</a>
        ...
        <div class="container_div">
            <div class="content">
                        <div class="content_title_wrapper">
                            <p class="content_title">연구 방향</p>
                            <p class="content_div_title_desc">
                                인공지능을 이용한 형상 · 비형상 설계정보 인식 기술 개발
                            </p>
                        </div>
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>설계 형상 정보 인식을 위한 기계 학습</li>
                            <li>Auto CAD와의 연계성</li>
                            <li>최적의 인식율 알고리즘 발굴</li>
                            <li>Legend에 의한 형상 인식 학습</li>
                            <li>다양한 해상도의 도면 인식 결과 보정 기술</li>
                            <li>오인식 결과에 대한 보정 학습</li>
                            <li>데이터 분석 툴 구현 및 분석 툴을 활용한 학습 데이터 생성</li>
                            <li>AI 전용 학습 관리 및 학습 모델 배포 관리 </li>
                        </ul>
                    </div>
                </div>
            </div>
