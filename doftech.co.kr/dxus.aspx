...
<body>
    <form name="aspnetForm" method="post" action="./dxus.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZJJa+Eg3NA6rQRPAVipfF8j3gEetjgUWVml+bKmHnuJV" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="D452872C" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="dxus.aspx">DXUS</a>
                ...
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>
                                <b>AI 기반 데이터 추출</b>
                                <p>선택한 파일과 매칭되는 Template 추천,  시스템 자동 선택 기능</p>
                                <p>맵핑 데이터에 따라 데이터 추출</p>
                                <p>이전 데이터 삭제 유무 선택  기능</p>
                            </li>
                            <li>
                                <b>테이블 추출 </b>
                                <p>개별 Property, Value를 별도의 선택 없이 한번에 추출</p>
                                <p>테이블 방향 선택 > 영역 설정 > 추출 </p>
                            </li>
                            <li>
                                <b>다양한 File 형태 지원 </b>
                                <p>Input 파일의 형식에 따른 추출 Template 생성 기능</p>
                                <p>PDF(Converted, Scanned), AutoCAD, Excel </p>
                                <p>Property, Value, Unit 영역 맵핑 기능 </p>
                                <p>Data 유형별(Property, Value, Unit)로 별도 색 부여 기능 </p>
                            </li>
                            <li>
                                <b>추출 Data Validation </b>
                                <p>추출된 데이터의 위치 확인 및 데이터 비교 및 수정</p>
                                <p>Image와 추출된 Text 확인후 Text 변경</p>
                                <p>추출된 속성 Table에서 Value값 구분</p>
                            </li>
