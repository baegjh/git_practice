...
<body>
    <form name="aspnetForm" method="post" action="./organization.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZKuIgUrn5di/UOBvFhpw4J+ISnUdJZvn2lbFRUZWPApZ" />
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="39A1C62C" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="organization.aspx">Organization</a>
    ...
    <div id="container" class="continaer_organization">
        <div class="container_div">
            <div class="content">
                <i>
                    <img src="img/organization.png" class="pcver" />
                    <img src="img/organization_m.png" class="mobver" />
                </i>
            </div>
        </div>
    </div>
