...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZJlIwicbyoCyJQXzlanMYIyQEI5G3yhWqJNtzjYBqaQ6" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E9CBED40" />
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelector('.tab1:nth-child(1)').addEventListener('click', function () {
                document.querySelector('.tab1:nth-child(1)').classList.add('on');
                document.querySelector('.tab1_iframe:nth-child(1)').style.display = 'block';
                document.querySelector('.tab1_text:nth-child(1)').style.display = 'block';

                document.querySelector('.tab1:nth-child(2)').classList.remove('on');
                document.querySelector('.tab1_iframe:nth-child(2)').style.display = 'none';
                document.querySelector('.tab1_text:nth-child(2)').style.display = 'none';
            });
            document.querySelector('.tab1:nth-child(2)').addEventListener('click', function () {
                document.querySelector('.tab1:nth-child(2)').classList.add('on');
                document.querySelector('.tab1_iframe:nth-child(2)').style.display = 'block';
                document.querySelector('.tab1_text:nth-child(2)').style.display = 'block';

                document.querySelector('.tab1:nth-child(1)').classList.remove('on');
                document.querySelector('.tab1_iframe:nth-child(1)').style.display = 'none';
                document.querySelector('.tab1_text:nth-child(1)').style.display = 'none';
            });
        });
    </script>
    <div id="container" class="container_location">
        <div class="location_box">
            <iframe class="tab1_content tab1_iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3162.660825533235!2d126.96735111577465!3d37.563054079798555!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357c989726b1b689%3A0x54d6230d62dfbd01!2z64-E7ZSE7YWNKOyjvCk!5e0!3m2!1sko!2skr!4v1612458140390!5m2!1sko!2skr"" frameborder="0" style="border: 0" allowfullscreen></iframe>
            <iframe class="tab1_content tab1_iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3162.5100845827906!2d126.96414226577481!3d37.56660477979788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca3b105316909%3A0x38b2247bdbf7d1c4!2z64-I7J2Y66y4IETtg4Dsm4w!5e0!3m2!1sko!2skr!4v1612458024343!5m2!1sko!2skr" frameborder="0" style="border: 0" allowfullscreen></iframe>
        </div>
        <div class="container_div">
            <div class="tab1_wrapper">
                <div class="tab1_wrapper_div" role="group">
                    <span class="tab1 on">Head Office</span>
                    <span class="tab1">Jongno Office</span>
                </div>
                <div class="tab1_content_wrapper">
                    <div class="tab1_content tab1_text">
                        <div>
                            <address>401, 86, Tongil-ro, Jung-gu, Seoul</address>
                        </div>
                        <div><span class="tel">+82-2-6354-9985</span><span class="fax">82-2-6733-1060</span></div>
                    </div>
                    <div class="tab1_content tab1_text">
                        <div>
                            <address>8F, 134, Tongil-ro, Jongno-gu, Seoul</address>
                        </div>
                        <div><span class="tel">+82-2-6354-9985</span><span class="fax">82-2-6733-1060
</span></div>
                    </div>
                </div>
            </div>
