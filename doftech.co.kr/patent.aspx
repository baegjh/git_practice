...
<body>
    <form name="aspnetForm" method="post" action="./patent.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZOaI1pyEOqSGUsQ+3ox3xByKX/ZiCACr2nuCNRqFhpr1" />
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="01EDEE57" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="patent.aspx">특허</a>
    ...
    <div id="container" class="container_patent">
        <div class="container_div">
            <div class="content content-grid">
                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_01.png">
                    </div>
                    <div class="card-header">인공지능 기반 플랜트 도면 내 심볼 자동인식 방법 및 장치</div>                               
                    <div class="card-footer">2020.04.20 | 출원/등록 번호 10-2104605</div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_02.png">
                    </div>
                    <div class="card-header">데이터베이스에 저장된 설계정보를 이용한 지능형 PID 도면의 자동 작성 방법</div>                               
                    <div class="card-footer">2020.08.11 | 출원/등록 번호 10-2145178</div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_03.png">
                    </div>
                    <div class="card-header">이미지화된 PID 도면에서 설계정보를 자동으로 인식하여 분류하는 방법</div>                               
                    <div class="card-footer">2020.11.05 | 출원/등록 번호 10-2177550</div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_04.png">
                    </div>
                    <div class="card-header">플랜트 최적 설계를 위한 배관의 자동 라우팅 방법</div>                               
                    <div class="card-footer">2022.04.08 | 출원/등록 번호 10-2386084</div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_05.png">
                    </div>
                    <div class="card-header">딥러닝 기반 플랜트 공정 설계 이상진단 자동화 장치 및 방법</div>                               
                    <div class="card-footer">2022.04.15 | 출원/등록 번호 10-2388788</div>
                </div>

                <div class="card">
                    <div class="card-body">
                        <img src="img/patent_img_06.png">
                    </div>
                    <div class="card-header" style="align-items:flex-start">
                        <span title="Method of authmatically recognizing and classifying design information in imaged PID drawing and method of automatically creating intelligent PID drawing using design information stored in database">
                            Method of authmatically recognizing and classifying design information in imaged PID drawing and method
                        of automatically creating intelligent PID drawing using design information stored in database
                        </span>
                    </div>                               
                    <div class="card-footer">2023.09.12, 미국 | 출원/등록 번호 16696953 </div>
                </div>
