...
<body>
    <form name="aspnetForm" method="post" action="./markus.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZI8JqW2I1Mi8lJimH5x+V+96Q2JkOEUSaDGWqirNYm6M" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="A29B34CB" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="markus.aspx">MARKUS</a>
    ...
    <div id="container" class="container_markus">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">주요기능</p>
                    <p class="content_div_title_desc">
                        이미지 comment를 기본으로 검토자 별 Comment Overlay, Rev.별 비교 조회, Auto CAD로의 저장 등의 기능 제공
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/markus_img_0.png" width="360" />
                        </i>
						<video with="360" height="270" controls>
							<source src="contents/MARKUS-DEMO.mp4" type="video/mp4">
						</video>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li>사용자 편의성
                            <p>Color에 의한 User별 Comment 구분</p>
                                <p>이전 문서와 비교가능 (달라진 부분 클라우드 마크)</p>
                                <p>즐겨찾기 기능 (thumb nail, comment, Page)</p>
                                <p>자주 사용하는 Symbol 등록 관리</p>
                                <p>검토자별 Comment Navigation 및 Comment Status 관리 기능</p>
                            </li>
                            <li>Auto CAD와의 연계성
                                <p>Comment 사항을 Auto CAD 파일에 저장</p>
                            </li>
                            <li>의사소통 및 Check 사항 관리
                                <p>검토자간 Communication을 위한 메신저 기능(M-talk)</p>
                                <p>검토자의 중요 점검 사항을 기록하고 진행 사항을 관리하는 Comment Manager 기능</p>
                            </li>
                        </ul>
                    </div>
                </div>
