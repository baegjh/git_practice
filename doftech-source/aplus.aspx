...
<body>
    <form name="aspnetForm" method="post" action="./aplus.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZHxFa0pMHyTgUMED5+UrBq/cTKR0Ivlx0LpnqO7QkGwz" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="EDB32D8E" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="aplus.aspx">APLUS</a>
                    ...
                    <a class="tab" href="commentus.aspx">CommentUS</a>
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    ...
                    <p class="content_div_title_desc">
                        배관 자동 경로 배치 솔루션 (Auto Pipe Layout with US)
                    </p>
                </div>
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li><b>Intelligent P&ID(ID2)</b>와의 연계를 통해 <b>Auto Routing을 위한 기본 정보 생성</b> 가능하도록 설계</li>
                            <li><b>AI 기반 및 Rule 관리</b>를 통한 최적의 <b>Routing Path</b> 설정 가능하도록 설계</li>
                            <li>비용을 고려하여 최적의 라우팅을 위한 라인 우선 순위 설정</li>
                            <li>Pump, Filter, Heat Exchanger에 대해 Special Pattern  적용</li>
                            <li>Geometry (3D 화면)을 통해 배관 Line을 수정하는 기능 제공</li>
                            <li>WBS별 배관 물량 산출</li>
                            <li>Case별 물량 비교 결과 리포트 생성</li>
                            <li>APLUS 3D 모델을 Autodesk Navisworks로 변환</li>
                            <li>APLUS 3D 모델을 Hexagon S3D / AVEVA E3D로 변환 </li>
                            <li>라우팅 결과(Success, Clash, Warning, Fail)를 원본 P&ID에 Markup</li>
                        </ul>
                    </div>
                </div>
            </div>
