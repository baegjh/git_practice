...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZAE55rmMFqxDuYpUNZdtR8lSb/PZP2lT4DhbjL90boEk" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="4E8B4398" />
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    ...
                    <p class="content_div_title_desc">
                        The <b>database</b> is replacing the excel-based data management system and connecting with other company's systems to <b>increase work efficiency.</b>
                    </p>
                </div>
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>Developing the <b>real-time data sharing</b> system</li>
                            <li>Managing engineering data by <b>each discipline</b></li>
                            <li>Making <b>seamless connection</b> with client’s system</li>
                            <li><b>Checking</b> engineering data history <b>remotely</b></li>
                            <li><b>Searching</b> data from Engineering Database <b>fast and efficiently</b></li>
                            <li>Executing biding processes and projects through the <b>efficient search</b> engine for Engineering Database</li>
                            <li>Increasing the <b>accuracy and consistency</b> of engineering data</li>
                            <li>Digitalizing engineering data for <b>cross-checking work</b> in Heat & Material Balance, Equipment List, Line list, etc.)</li>
                            <li><b>Linking</b> P&ID data with a 3D Model automatically</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">ISSUE –R<br /></p>
                        <p class="content_div_title_desc">
                            The system can manage the <b>revision information of ISO</b> drawings to save man-hours.
                        </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>Automatically <b>recognizing revision changes</b></li>
                            <li>Adopting the <b>automatic marking system</b> to save man-hours</li>
                            <li><b>Comparing revision information</b> by issuing stages</li>
                            <li>Not requiring any knowledge on CAD Softwares</li>
                            <li><b>Preventing missing marks</b> for revision information</li>
                            <li><b>Generating the report</b> for revision information</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="content">
                <div class="content_title_wrapper">
                   <p class="content_title">E-LOAD<br /></p>
                        <p class="content_div_title_desc">
                            The <b>Integrated Managing Tool for Electrical Load Data</b> to increase accuracy and save man-hours through automatic processing of deliverables.
                        </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>Calculation of Electrical Load Summary
                                 <p>Importing Load Summary from Excel files</p>
                                 <p>Assigning Load Bus</p>
                                 <p>Calculating Virtual Load Summary</p>
                            </li>
                            <li>Calculation of Cable Schedule
                                <p>Importing Cable Schedule from Excel files</p>
                                <p>Calculating Cable BOM Summary</p>

                            </li>
                            <li>Calculation of Drum Schedule
                                <p>Setting up Drum Naming Rules</p>
                                <p>Generating Drum Schedule</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    ...
                    <p class="content_div_title_desc">
                        The system supports <b>ISO drawing works</b> and manages construction quantity / work management and quality / safety / resource.
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                    ...
                    <div class="text_wrapper">
                        <ul>
                            <li>Joint Control
                                <p>Customizing shortcut keys for any repetitive works</p>
                                <p>Monitoring joint conditions in real-time</p>
                            </li>
                            <li>Spool Control
                                <p>Monitoring spool conditions in real-time</p>
                            </li>
                            <li>Revision Control
                                <p>Comparing revision information on drawings with their previous version </p>
                            </li>
                        </ul>
                    </div>
                </div>
