...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZKAXj8rYlfMQb8xMg6wJP0Ylwq+Y7ZsvHxve4bxitiZa" />
                        ...
                        <div class="swiper-slide light_slide" style="background-image: url(./img/swiper_img_0.jpg)">
                            <div class="slogan_wrapper">
                                <h3 class="slogan">
                                    ...
                                    <span class="slogan_desc">We provide AI based solutions & services<br /> <b>customized</b> to your <b>NEEDS</b>.</span>
                                </h3>
                            </div>
                        </div>
        ...
        <div class="content" role="contentinfo">
            <ul>
                <li class="banner_menu">
                    <a href="ars.aspx" title="">
                        <p class="banner_menu_p background_img" style="background-image: url(./img/default_banner_0.png)"></p>
                        <p class="banner_menu_p text">
                            <span class="banner_menu_title">SOLUTION PACKAGE</span>
                            <span class="banner_menu_title_desc">Engineering IT about Solution Package</span>
                        </p>
                    </a>
                </li>
                <li class="banner_menu">
                    <a href="engineering.aspx" title="">
                        ...
                        <p class="banner_menu_p text">
                            ...
                            <span class="banner_menu_title_desc">Plant &amp; Engineering IT, SI Service</span>
                        </p>
                    </a>
                </li>
                <li class="banner_menu">
