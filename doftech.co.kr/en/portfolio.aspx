...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZA46EYELKjWmyC6x28T7MN9rTOr5uO5b3xrsrvzq+V2k" />
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="0BAB12A5" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="portfolio.aspx">Client</a>
    ...
    <div id="container" class="container_portfolio">
        <div class="container_div">
            <div class="content">
                <ul class="thum_wrapper">
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_16_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_00_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_01_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_02_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_03_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_04_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_05_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_06_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_07_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_08_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_09_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_10_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_11_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_12_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_13_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_14_en.png">
                        </i>
                    </li>
                    <li class="thum">
                        <i>
                            <img src="img/portfolio_img_17_en.png">
                        </i>
                    </li>
                </ul>
            </div>
