...
<body>
    <form name="aspnetForm" method="post" action="./ars.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZGfsuAoqWhKExwL8TxIalUjqUxW7UBvrFLGQeX1EKgrq" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="E80BA630" />
        ...
        <div id="wrap">
            ...
            <div id="visual">
                <div class="background_img" style="background-image: url('./img/visual_img_0.png')"></div>
            </div>
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="ars.aspx">ARS (Pipe Auto Routing System for EPC)</a>
                    
                    <a class="tab" href="id2.aspx">ID2</a>
                    
                    <a class="tab" href="markus.aspx">MARKUS</a>
                    
                    <a class="tab" href="issue_i.aspx">ISSUE-I</a>
    ...
    <style type="text/css">
        ...
        .nav .nav_menu:nth-child(1) h3 a {
            color: #044C8B !important;
            font-weight: 800;
        }

        .nav .nav_menu:nth-child(1) h3 a .bar {
            transform: scaleX(1);
            background: #044C8B;
        }
    ...
    <div id="container" class="container_ars">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">Main Function</p>
                    
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/ars_img_0.png" width="500" /><br>
                            <img src="img/ars_img_1.png" width="500" /><br>
						</i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li>Designed to enable the generation of <b>basic information for Auto Routing</b> <br /> integration with <b>Intelligent P&ID (ID2)</b>.</li>
                            <li>Designed to allow optimal <b>Routing Path</b> configuration through <b>Rule</b> management.</li>
                            <li>Prioritizes line sequencing for optimal routing considering cost.</li>
                            <li>Applies special patterns for Pump, Filter, and Heat Exchanger.</li>
                            <li>Provides the functionality to modify piping lines using geometry (3D view).</li>
                            <li>Calculates piping quantities by WBS.</li>
                            <li>Generates reports comparing quantities for each case.</li>
                            <li>Converts ARS 3D models to Autodesk Navisworks.</li>
                            <li>Converts ARS 3D models to Hexagon S3D / AVEVA E3D.</li>
                            <li>Marks routing results (Success, Clash, Warning, Fail) on the original P&ID.</li>
