...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZEjZHM+FPL6UcY+eW2irfG2sMNeF4ZgD4dOr7rXIAmtk" />
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="796F993D" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="careers.aspx">인사제도</a>
                    
                    <a class="tab" href="benefit.aspx">교육·복리후생</a>
    ...
    <div id="container" class="container_careers">
        <div class="container_div" style="margin-bottom:0; padding-bottom:0;">        
        <ul class="box_wrapper" style="margin-bottom:0;">
            <li class="list_box">
                <div class="box">
                    <p class="box_title">
                        Innovation<br />
                    </p>
                    <p class="box_title_desc">
                        열정적인 도전으로<br />
                        혁신을 주도 하는 인재<br />
                    </p>
                    <i>
                        <img src="img/careers_ico_0_0.png" /></i>
                    <p class="box_desc">
                        다양한 시각과 열정으로
                        새로운 영역을 향한 도전!
                    </p>
            ...
            <li class="list_box">
                <div class="box">
                    ...
                    <i>
                        <img src="img/careers_ico_0_1.png" /></i>
                    <p class="box_desc">
                        서로를 존중하고 신뢰하며
                        협업을 통한 시너지 창출
                    </p>
            ...
            <li class="list_box">
                <div class="box">
                    ...
                    <i>
                        <img src="img/careers_ico_0_2.png" /></i>
                    <p class="box_desc">
                        자신의 일에 대한
                        자부심과 가치창출에 대한 행동
                    </p>
        ...
        <div class="container_div">
            <div class="text">
                <h2 class="content_title">인재 채용 프로세스
                </h2>
            </div>
            <div class="content">
                <ul class="procedure_wrapper">
                    <li class="procedure">
                        <i>
                            <img src="img/careers_ico_1_0.png" /></i>
                        <p class="procedure_desc">
                            입사지원
                        </p>
                    </li>
                    <li class="procedure">
                        <i>
                            <img src="img/careers_ico_1_1.png" /></i>
                        <p class="procedure_desc">
                            서류전형
                        </p>
                    </li>
                    <li class="procedure">
                        <i>
                            <img src="img/careers_ico_1_2.png" /></i>
                        <p class="procedure_desc">
                            1차 면접
                        </p>
                    </li>
                    <li class="procedure">
                        <i>
                            <img src="img/careers_ico_1_3.png" /></i>
                        <p class="procedure_desc">
                            2차 면접
                        </p>
                    </li>
                    <li class="procedure">
                        <i>
                            <img src="img/careers_ico_1_4.png" /></i>
                        <p class="procedure_desc">
                            입사
                        </p>
                    </li>
