...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZEkkvrh7kwxADXBFVI0ekEnvW30X+pbCV5okZFctK40/" />
...
<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="934464BD" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="organization.aspx">조직도</a>
    ...
    <div id="container" class="container_organization">
        <div class="container_div">
            <div class="content">
                <i>
                    <img src="img/organization_new.png" class="pcver" />
                    <img src="img/organization_m_new.png" class="mobver" />
                </i>
            </div>
        </div>
    </div>
