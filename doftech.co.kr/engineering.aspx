...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZNtJ7ndJGS3G3jv3/UUW49e03hfK43dOrnbkUV1Btwa9" />
                ...
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">3D SUPPORT 형상 개발 (S3D · PDMS · PDS)</p>
                        </div>
                        <ul>
                            <li>수행 프로젝트에 대한 3D Support Data를 체계적으로 분류 관리</li>
                            <li>Support 형상을 프로세스에 맞게 자체 개발 하여 품질 및 전반적인 프로젝트 완성도 향상</li>
                            <li>프로그래밍 기술이 필요한 3D admin 업무의 형상 개발 지원 라이브러리 구축</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container_div">
            <div class="content">
                <div class="content_div">
                    ...
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">PDS to SP3D 변환 프로젝트 수행</p>
                        </div>
                        <ul>
                            <li>KNPC(Kuwait National Petroleum Company)에서 발주한 Project에 대하여 SP3D 변환 용역 수행</li>
                            <li>Support 형상을 프로세스에 맞게 자체 개발하여 품질 및 전반적인 프로젝트 완성도 향상</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="content_div">
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">
                                3D CAD 프로젝트 수행 내역<br />
                            </p>
                        </div>
                        <ul>
                            <li>Project Setup (Server / Network / 협력사 / 현장)</li>
                            <li>Coordination (설계팀 / Material팀/ 협력사 / 사업주)</li>
                            <li>Material Spec , V/P 등 RDB Update</li>
                            <li>Interference Check 관리</li>
                            <li>Instruction 및 Training</li>
                            <li>G/A 도면 관리</li>
                            <li>Product Issue 관리(도면,BM)</li>
                            <li>협력사 원격 지원</li>
                            <li>Backup 관리</li>
                            <li>기타 운영 일체</li>
                        </ul>
                    ...
                    <div class="graph_wrap">
                        <div class="graph_wrapper">
                            ...
                            <p class="graph_wrapper_title">수행 프로젝트</p>
                        </div>
                    </div>
                </div>
            </div>
