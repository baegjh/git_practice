...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZMoEqZghv2pR0MdYvHj/Vt+1b85VBS6bTz7GXCsEMbQf" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="94380433" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab" href="ai.aspx">AI 기반 도면 인식</a>
            ...
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">주요기능</p>
                        <p class="content_div_title_desc">클라우드 기반 기본설계 및 FEED 업무 자동화 지원 시스템</p>
                </div>
                <div class="content_div">
                    ...
                    <ul>
                        <li>주요 FEED 업무(공정) 지원 Module
                            <p>Image P&ID 도면 인식 →  데이터화</p>
                            <p>SP P&ID, AVEVA P&ID 로 Conversion</p>
                            <p>Hydraulic Calculation, H&MB 관리</p>
                            <p>Datasheet , List 류 Interface (Export)</p>
                            <p>Revision History Tracking</p>
                        </li>
                        <li>Auto Routing Module (FEED 수준)
                            <p>설계 적용 : 배관 상세 설계 (FEED 수준)</p>
                            <p>3D Model, 자재 산출</p>
                            <p>VR/MR 적용 예정</p>
                            <p>EPC 수준으로 Upgrade 예정</p>
                        </li>
                        <li>Cost Estimation Module (Class 3 기준)
                            <p>Engineering Economic 분석</p>
                        </li>
                    </ul>
                    </div>
                </div>
