...
<body>
    <form name="aspnetForm" method="post" action="./ai.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZHtKCCqGH0Ivf+oR9O4xPxx6o62hVtYLe+4NQU7zGlQj" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="7948A0B7" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab" href="feed.aspx">SmartFEED</a>
                    
                    <a class="tab on" href="ai.aspx">AI-based Drawing<br> Recognition Technology</a>
    ...
    <div id="container" class="container_ai">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">Main Function</p>
                    <p class="content_div_title_desc">
                        Developing the AI-based technology to recognize various symbols used in engineering drawings.
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/ai_img_0.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li>Machine learning technique to increase the rate of recognition for symbols or shapes on engineering drawings</li>
                            <li>Closely integrated with Auto CAD program</li>
                            <li>Developing the most efficient algorithm for optimized recognition rate</li>
                            <li>More recognized symbols or shapes by using legend drawings</li>
                            <li>Developing the cutting-edge technology to automatically correct recognition results from drawings with poor resolution</li>
                            <li>Generating learning data from engineering data analyzing tools </li>
                            <li>Managing models based on machine learning algorithm learning</li>
                        </ul>
                    </div>
                </div>
            </div>
