...
<body>
    <form name="aspnetForm" method="post" action="./feed.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZEZj9c3NFXZxc4KbS6iopR/vROKj3dCQuEmT2jAmKWIQ" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="8FD5450A" />
        ...
        <div id="wrap">
            ...
            <div id="visual">
                <div class="background_img" style="background-image: url('./img/visual_img_2.png')"></div>
            </div>
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="feed.aspx">SmartFEED</a>
                    
                    <a class="tab" href="ai.aspx">AI-based Drawing<br> Recognition Technology</a>
    ...
    <style type="text/css">
        .nav .nav_menu:nth-child(3) h3 a {
            color: #044C8B !important;
            font-weight: 800;
        }

            .nav .nav_menu:nth-child(3) h3 a .bar  {
                transform: scaleX(1);
                background: #044C8B;
            }
    ...
    <div id="container" class="container_feed">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">Main Function</p>
                        <p class="content_div_title_desc">Developing the basic engineering design and FEED package in a cloud system by providing AI-based automation tools.
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                        <img src="img/feed_img_0.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                    <ul>
                        <li>Intelligent PFD Module
                            <p>Automatically recognizing revised data and management systems specific to PFD drawings</p>
                        </li>
                        <li>Intelligent P&ID Module
                            <p>Importing or exporting engineering data from/to datasheets and various lists</p>
                            <p>Converting image files to intelligent P&IDs, like SPPID (Hexagon) or AVEVA P&ID</p>
                        </li>
                        <li>Auto Routing Module
                            <p>Applying to piping detailed design</p>
                            <p>Generating BOM reports</p>
                            <p>Connecting the module with VR or MR technology</p>
                        </li>
                        <li>Cost Estimation Module (Class III)
                            <p>Analyzing engineering documents and generating cost estimates automatically</p>
                        </li>
                    </ul>
                    </div>
                </div>
