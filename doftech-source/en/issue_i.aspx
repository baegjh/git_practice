...
<body>
    <form name="aspnetForm" method="post" action="./issue_i.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZJYu9nYVfKfdiNYU9WBv7n0MGKNosl/70VkUnnwQUybN" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="62B165C2" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="issue_i.aspx">ISSUE-I</a>
    ...
    <div id="container" class="container_issuei">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">Main Function</p>
                    <p class="content_div_title_desc">
                        Managing drawings and BOM files to issue <b>error-free deliverables</b> based on the latest information.
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/issuei_img_0.png"/>
                            
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li><b>Updating</b> documents based on <b>the latest 3D Model automatically</b></li>
                            <li><b>Generating BOM</b> files in any formats</li>
                            <li>Updating ISO drawings automatically</li>
                            <li><b>Incorporating any changes of line data</b> into the 3D Model easily</li>
                            <li><b>Generating drawing index</b> automatically</li>
                            <li>Providing the function of <b>BATCH PLOTTING </b></li>
                            <li>Providing other utilities for user conveniences</li>
