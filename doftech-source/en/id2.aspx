...
<body>
    <form name="aspnetForm" method="post" action="./id2.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZFUew52o3K5QhJImw8j5uwWgmBVoFgKCoCR0HkyB1nIA" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="03808706" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab" href="ars.aspx">ARS (Pipe Auto Routing System for EPC)</a>
                    
                    <a class="tab on" href="id2.aspx">ID2</a>
    ...
    <div id="container" class="container_id2">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">Main Function</p>
                    <p class="content_div_title_desc">
                        <b>Digitalizing all engineering information</b> on PFD and P&IDs <b>in various formats</b> such as PDF, Scanned Images, or AutoCAD files.
                    </p>
                ...
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/id2_img_0.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li><b>Exporting all engineering information</b> recognized by Machine Learning technique <b>to Engineering Database</b> to use it in other documents such as
                                <p> Data sheets (equipment & instrument) </p>
                                <p> Equipment list</p>
                                <p> Line list</p>
                                <p> Instrument list</p>
                                <p> Valve list</p>
                            ...
                            <li><b>Validation function</b> provided to increase accuracy in auto-recognition results</li>
                            <li><b>Converting paper P&IDs to Intelligent P&IDs</b> such as SPP&ID (Hexagon) or AVEVA P&IDs automatically</li>
                            <li><b>Reporting functions</b> to generate other engineering documents such as Line List, Equipment list, Instrument list, Valve list, Note list, BOM, etc.</li>
                        </ul>
                    </div>
                </div>
            </div>
