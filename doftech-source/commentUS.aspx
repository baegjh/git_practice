...
<body>
    <form name="aspnetForm" method="post" action="./commentus.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZP0PAvlYBHoCe1gPnoVBjtuUnLlI6eAUoFPbO42rugxj" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="571DD320" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab" href="aplus.aspx">APLUS</a>
                    
                    <a class="tab" href="id2.aspx">ID2</a>
                    
                    <a class="tab" href="markus.aspx">MARKUS</a>
                    
                    <a class="tab" href="dxus.aspx">DXUS</a>
                    
                    <a class="tab on" href="commentus.aspx">CommentUS</a>
    ...
    <div id="container" class="container_commentus">
        <div class="container_div">
            <div class="content">
                <div class="content_title_wrapper">
                    <p class="content_title">주요기능</p>
                    <p class="content_div_title_desc">
                        3D Model Review Comment Tool
                    </p>
                </div>
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/commentus_img_0.png" width="500" /><br>
						</i>
                    </div>
                    <div class="text_wrapper">
                        <ul>
                            <li>Comment의 효율적 관리 및 부서간 반영 현황 공유 및 검색, Snapshot, Report 등<br /> 다양한 기능을 제공하여 업무 효율 증대 및 사용자 오류를 최소화</li>
                            <li>발주처 설계변경 요청사항 통합 관리</li>
                            <li>코멘트관리 시스템화를 통해 엑셀 기반 코멘트 관리에 소요되는 M/H 낭비 최소화</li>
                            <li>설계데이터의 Single Input Multiple Output 적용으로 리뷰 환경 제공</li>
                            <li>유관 공종 및 작업자 업무 status cross checking등 효율적인 업무 협업 지원</li>
                            <li>SPR/Navisworks 연동  및 Tag 생성</li>
                            <li>Snapshot 이미지 수정</li>
                            <li>Comment 변경 이력 관리</li>
                            <li>프로젝트별 다양한 양식의 Report 작성 및 Comment History 확인</li>
                            <li>3D Model 이미지 Capture 및 Mark-up (Comment 전/후 비교)</li>
                            <li>Report 미리 보기 기능 최소화 및 Paper 소모 최소화</li>
                        </ul>
                    </div>
                </div>
            </div>
