    ...
    setTranslate: function setTranslate() {
      ...
      for (var i = 0; i < slides.length; i += 1) {
        ...
        $slideEl
          ...
          //console.log($slideEl.hasClass('white_slide'));
          //console.log(swiper.slides[opacity *= 1]);
        }
        //console.log(swiper.slides.css('opacity') == 1);
        //console.log("/" + swiper.slides.length);
        //console.log(swiper.$wrapperEl.children()+[opacity *= 1]);
        //console.log($('.swiper-slide[opacity *= 1]'))
    },
    setTransition: function setTransition(duration) {
      var swiper = this;
      var slides = swiper.slides;
