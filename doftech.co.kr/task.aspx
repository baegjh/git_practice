...
<body>
    <form name="aspnetForm" method="post" action="./task.aspx" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZPiJ/r1DMfJBVw4mLnvhj6jlG+EJgfNmifmBWWEp3Sza" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="3C3F6E02" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="task.aspx">직무소개</a>
    ...
    <div id="container" class="container_task">
        <div class="container_div">
            <div class="content">
                <ul class="task_wrapper">
                    <li class="task">
                        <i>
                            <img src="img/task_img_00.png" />
                        </i>
                    </li>
                    <li class="task">
                        <i>
                            <img src="img/task_img_01.png" />
                        </i>
                    </li>
                    <li class="task">
                        <i>
                            <img src="img/task_img_02.png" />
                        </i>
                    </li>
                    <li class="task">
                        <i>
                            <img src="img/task_img_03.png" />
                        </i>
                    </li>
                </ul>
            </div>
