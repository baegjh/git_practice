...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwULLTEwMDUyNjYzMjhkZBy6PGqrewuTHGg9Ev7B5iUR2S/uqUBWz/Ej0cytJmvd" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="42A95EC6" />
        ...
        <div id="wrap">
            ...
            <div class="tab_wrapper">
                ...
                <div class="tab_wrapper_div" role="group">
                    ...
                    <a class="tab on" href="engineering.aspx">Plant & Engineering IT</a>
                    
                    <a class="tab" href="si.aspx">SI (System Integration)</a>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function scroll() {
                if (window.pageYOffset > 1000) {
                    document.querySelector('.graph_div:nth-child(1) .bar').style.animation = 'fill_graph1 1s ease-out 0s forwards';
                    document.querySelector('.graph_div:nth-child(2) .bar').style.animation = 'fill_graph2 1s ease-out 0.5s forwards';
                    document.querySelector('.graph_div:nth-child(3) .bar').style.animation = 'fill_graph3 1s ease-out 1s forwards';
                    document.querySelector('.graph_div:nth-child(4) .bar').style.animation = 'fill_graph4 1s ease-out 1.5s forwards';

                }
            }
        })
    </script>
    <div id="container" class="container_engineering">
        <div class="container_div">
            <div class="content">
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/engineering_img_0.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">Developing 3D SUPPORT SHAPE (S3D/PDMS/PDS)</p>
                        </div>
                        <ul>
                            <li><b>Managing 3D shapes of all supports</b> for structural steels, piping, or other items efficiently</li>
                            <li>Developing <b>custom-made 3D support shapes</b> according to client's requirement</li>
                            <li>Building 3D <b>supporting shape libraries</b> which require programming works</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="content">
                <div class="content_div">
                    <div class="img_wrapper">
                        <i>
                            <img src="img/engineering_img_1.png" />
                        </i>
                    </div>
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">Converting PDS file to SP3D file</p>
                        </div>
                        <ul>
                            <li><b>Converting 3D support shapes</b> developed for PDS <b>to SP3D format</b> to meet project requirements</li>
                            <li><b>Applied</b> auto-coverting technology to <b>KNPC (Kuwait National Petroleum Company) projects</b></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="text_wrapper">
                        <div class="content_title_wrapper">
                            <p class="content_title">
                                Execution Details of 3D CAD Works<br />
                            </p>
                        </div>
                        <ul>
                            <li>Project Setup at various location (server/network/partner/field)</li>
                            <li><b>Coordination</b> with Project Stakeholders (Engineering Team / Material Team / Partner / Owner)</li>
                            <li><b>Updating automatically</b> material specification, vendor prints, RDB, etc. </li>
                            <li>Managing <b>interference check</b></li>
                            <li>Providing <b>instruction and training</b> session</li>
                            <li>Managing <b>General Assembly Drawings</b> efficiently</li>
                            <li>Managing product <b>issue status</b> (drawing, BM )</li>
                            <li>Supporting partners <b>remotely</b></li>
                            <li>Managing <b>Engineering Backup System</b> efficiently</li>
                            <li>Supporting other operations <b>until project completion</b></li>
                        </ul>
                    </div>
                        ...
                        <div class="graph_wrapper">
                            <div class=" graph">
                                <div class="graph_div">
                                    ...
                                    <strong class="bar_title">PDS</strong>
                                </div>
                                <div class="graph_div">
                                    <div class="bar_wrapper">
                                        <p class="bar">
                                    ...
                                    <strong class="bar_title">PDMS</strong>
                                </div>
                                <div class="graph_div">
                                    <div class="bar_wrapper">
                                        <p class="bar">
                                    ...
                                    <strong class="bar_title">S3D</strong>
                                </div>
                                <div class="graph_div">
                                    <div class="bar_wrapper">
                                        <p class="bar">
                                    ...
                                    <strong class="bar_title">PDS to S3D</strong>
                                </div>
                            </div>
                            <p class="graph_wrapper_title">Performed Project</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container_div">
            <div class="content diagram_wrapper">
                <i>
                    <img src="img/engineering_img_4.png" class="pcver" />
                    <img src="img/engineering_img_4_m.png" class="mobver" />
                </i>
                <i>
                    <img src="img/engineering_img_6.png" class="pcver" />
                    <img src="img/engineering_img_6_m.png" class="mobver" />
                </i>
                <i>
                    <img src="img/engineering_img_5.png" class="pcver" />
                    <img src="img/engineering_img_5_m.png" class="mobver" />
                </i>
            </div>
        </div>
    </div>
